...
class _SingInPageState extends State<SingInPage> {
  ...
  late AdministradorData administradorData =
      AdministradorData(id: 0, nome: "", email: "", senha: "", confirmarSenha: "");
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (administradorData.nome == "") {
        ...
        Fluttertoast.showToast(
            ...
            backgroundColor: Colors.red,
            fontSize: 20.0);
      } else if (administradorData.senha == "") {
        Fluttertoast.showToast(
            ...
            backgroundColor: Colors.red,
            fontSize: 20.0);
      } else if (administradorData.confirmarSenha == "") {
        Fluttertoast.showToast(
            ...
            backgroundColor: Colors.red,
            fontSize: 20.0);
      } else if (administradorData.senha != administradorData.confirmarSenha) {
        Fluttertoast.showToast(
